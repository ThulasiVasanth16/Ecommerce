            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  DoorNo: 4/31 Near VGP Theme Park, <br /> Vettuvankeni,chennai
                  <br />
                  PinCode: 600-115
                </address>
                <a
                  href="tel:+91 9361562608"
                  className="mb-3 d-block mb-1 text-white"
                >
                  +91 9361562608
                </a>
                <a
                  href="mailto:thulasivasanth@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  thulasivasanth@gmail.com
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy;{new Date().getFullYear()},  Powered by Vasanth{" "}
              </p>
            </div>
          </div>
        </div>
